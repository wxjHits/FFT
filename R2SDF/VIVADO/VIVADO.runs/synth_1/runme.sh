...
HD_PWD='C:/Users/hp/Desktop/FFT/R2SDF/VIVADO/VIVADO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log R2SDF_FFT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source R2SDF_FFT.tcl
